/*! For license information please see main.268267b4.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function as(e, n) {
          ...
          if (0 !== n) {
            if (
              ...
              throw ((t = Di), ps(e, 0), is(e, r), ls(e, Xe()), t);
            if (6 === n) is(e, r);
            else {
              if (
        ...
        function ss(e) {
          ...
          if (1 === t) throw ((t = Di), ps(e, 0), is(e, n), ls(e, Xe()), t);
        ...
        function gs(e, n) {
          ...
          if ((ka(), (zi = t), (Ci.current = r), null !== Ti))
            throw Error(a(261));
        ...
        function Ms(e, n, t, r, l, o) {
          ...
          if (((r = e), "function" === typeof e)) Rs(e) && (u = 1);
            ...
            e: switch (e) {
              ...
              case _:
                return (
                  ((e = Os(12, t, n, 2 | l)).elementType = _), (e.lanes = o), e
                );
              case z:
                return (
              ...
              case L:
                return (
                  ((e = Os(19, t, n, l)).elementType = L), (e.lanes = o), e
                );
              case R:
                return Is(t, l, o, n);
              default:
  ...
  !(function () {
    ...
    var l = t(791),
      a = "Section_section__P88MK",
      o = t(184),
      u = function (e) {
        return (0, o.jsx)("section", { className: a, children: e.children });
      },
      i = "TaskItem_task__pJBUn",
      s = function (e) {
        return (0, o.jsx)("li", { className: i, children: e.children });
      },
      c = "Tasks_container__CZNQQ",
      f = function (e) {
        var n = (0, o.jsx)("h2", {
          children: "No tasks found. Start adding some!",
        });
        e.items.length > 0 &&
          (n = (0, o.jsx)("ul", {
            children: e.items.map(function (e) {
              return (0, o.jsx)(s, { id: e.id, children: e.text }, e.id);
            }),
          }));
        var t = n;
        return (
          ...
          e.loading && (t = "Loading tasks..."),
          (0, o.jsx)(u, {
            children: (0, o.jsx)("div", { className: c, children: t }),
          })
        );
      },
      d = "TaskForm_form__8fr-k",
      p = function (e) {
        var n = (0, l.useRef)();
        return (0, o.jsxs)("form", {
          ...
          onSubmit: function (t) {
            t.preventDefault();
            var r = n.current.value;
            r.trim().length > 0 && e.onEnterTask(r);
          },
          children: [
            (0, o.jsx)("input", { type: "text", ref: n }),
            (0, o.jsxs)("button", {
              className: "btn",
              children: [
                !e.loading && (0, o.jsx)("i", { class: "bi bi-plus-circle" }),
                e.loading ? "Sending..." : " Add Task",
              ],
            }),
            (0, o.jsxs)("a", {
              className: "btn",
              ...
              target: "_blank",
              children: [
                (0, o.jsx)("i", { class: "bi bi-filetype-jsx" }),
                " Source Code",
              ],
            }),
          ],
    ...
    function m() {
      ...
      function s(e, n, t, l) {
        var a = n && n.prototype instanceof d ? n : d,
          ...
          u = new P(l || []);
        return r(o, "_invoke", { value: x(e, t, u) }), o;
      }
      function c(e, n, t) {
        try {
      ...
      function S(e, n) {
        function l(r, a, o, u) {
          ...
          if ("throw" !== i.type) {
            var s = i.arg,
              f = s.value;
            return f && "object" == h(f) && t.call(f, "__await")
      ...
      function x(e, n, t) {
        ...
        return function (l, a) {
          ...
          for (t.method = l, t.arg = a; ; ) {
            ...
            var i = c(e, n, t);
            if ("normal" === i.type) {
              if (((r = t.done ? "completed" : "suspendedYield"), i.arg === f))
                continue;
      ...
      function E(e, n) {
        ...
        if ("throw" === l.type)
          return (n.method = "throw"), (n.arg = l.arg), (n.delegate = null), f;
        var a = l.arg;
        return a
          ? a.done
      ...
      return (
        ...
        (p.displayName = i(v, u, "GeneratorFunction")),
        ...
        k(S.prototype),
        i(S.prototype, o, function () {
          return this;
        }),
        (e.AsyncIterator = S),
        (e.async = function (n, t, r, l, a) {
          void 0 === a && (a = Promise);
          var o = new S(s(n, t, r, l), a);
        ...
        (P.prototype = {
          ...
          finish: function (e) {
            for (var n = this.tryEntries.length - 1; n >= 0; --n) {
              ...
              if (t.finallyLoc === e)
                return this.complete(t.completion, t.afterLoc), C(t), f;
            }
          },
          catch: function (e) {
            for (var n = this.tryEntries.length - 1; n >= 0; --n) {
    ...
    var k = function (e, n) {
        var t = r((0, l.useState)(!1), 2),
          a = t[0],
          o = t[1],
          u = r((0, l.useState)(null), 2),
          i = u[0],
          s = u[1],
          c = (function () {
            var t,
              r =
                ((t = m().mark(function t(r) {
                  var l, a;
                  return m().wrap(
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 8:
                            return (t.next = 10), l.json();
                          case 10:
                            (a = t.sent), e(a, r), (t.next = 17);
                            break;
                          case 14:
                            (t.prev = 14),
                              (t.t0 = t.catch(2)),
                              s(t.t0.message || "Something went wrong!");
                          case 17:
                            o(!1);
                          case 18:
                          case "end":
        ...
        return { isLoading: a, error: i, fetchApi: c };
      },
      S = function (e) {
        var n = k(
            function (n, t) {
              var r = { id: n.name, text: t };
              e.onAddTask(r);
            },
        ...
        return (0, o.jsxs)(u, {
          children: [
            ...
            r && (0, o.jsx)("p", { children: r }),
          ],
        });
      };
    var x = function () {
      var e = r((0, l.useState)([]), 2),
        n = e[0],
        t = e[1],
        a = (0, l.useCallback)(function (e) {
          var n = [];
          for (var r in e) n.push({ id: r, text: e[r].text });
          t(n);
        }, []),
        u = k(a, null),
        i = u.isLoading,
      ...
      return (
        ...
        (0, o.jsxs)(l.Fragment, {
          children: [
            ...
            (0, o.jsx)(f, { items: n, loading: i, error: s, onFetch: c }),
          ],
        })
      );
    };
    e.createRoot(document.getElementById("root")).render((0, o.jsx)(x, {}));
  })();
})();
//# sourceMappingURL=main.268267b4.js.map
